...
| Complete Installer | 2.8.0 | Adds a guided OpenWebUI first-login/API-key cutover, installer progress/heartbeat status, a managed OpenWebUI update contract (`Update-KIStack-OpenWebUI.cmd`, upgrade/downgrade/Skip/automatic rollback) and payload deployment hygiene; regression- and real-target-validated (see `docs/releases/complete-installer-v2.8.0.md`). 2.7.0 (`KI-Stack-Complete-Installer-v2.7.0.zip`, SHA256 `438887892bf9cc47ba3bde5432e298b461d24fa4a85117910ac4811a302a81bb`) remains the latest published [GitHub Release](https://github.com/robertbackhaus-a11y/KI-Stack/releases/tag/2.7.0); 2.8.0 is not yet tagged or published. Builds on 2.5.0's physical Greenfield installation and 2.6.0's RAG remote-rollback completion, both still current. |
