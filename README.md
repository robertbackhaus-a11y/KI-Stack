...
| Complete Installer | 2.12.0 | Current repository/development state, not yet published as a GitHub Release: bundles the Cutover Runtime, OpenWebUI Agent Pack, and RAG bumps above (new `ki-stack-research` reference agent, the Agent-Pack reconcile field-ownership/preserve contract, RAG project-scoping, the Integration RAG-starter-preservation fix). Deterministic dual-build and PackageSelfTest (28/28) reverified against this state. 2.10.0 (`KI-Stack-Complete-Installer-v2.10.0.zip`) remains the latest published [GitHub Release](https://github.com/robertbackhaus-a11y/KI-Stack/releases/tag/2.10.0); see `docs/releases/complete-installer-v2.10.0.md` and `docs/releases/complete-installer-v2.10.1.md` for that release's and the subsequent 2.10.1 maintenance update's full feature sets. |
