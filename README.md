...
| Models / Workflows | 1.4.7 | Central transactional ComfyUI and Heretic LM Studio external-model importer; bilingual provisioning documentation |
...
| Complete Installer | 2.2.7 | Enforces the external ComfyUI and Heretic LM Studio contracts before Models / Workflows compliance; bilingual documentation included |
