...
| Complete Installer | 2.7.0 | Stable; latest published [GitHub Release](https://github.com/robertbackhaus-a11y/KI-Stack/releases/tag/2.7.0) (`KI-Stack-Complete-Installer-v2.7.0.zip`, SHA256 `438887892bf9cc47ba3bde5432e298b461d24fa4a85117910ac4811a302a81bb`). Fixes a real Codex Local LM Studio first-run timing defect found during the 2.5.0 Greenfield acceptance run; regression- and real-target-validated (see `docs/releases/complete-installer-v2.7.0.md`). Builds on 2.5.0's physical Greenfield installation and 2.6.0's RAG remote-rollback completion, both still current. |
