...
| Complete Installer | 2.18.1 | Aktuell veröffentlichtes GitHub-Release `v2.18.1`. Enthält die MCP Foundation aus 2.15, autonomes Local Control aus 2.16, natives persistentes OpenWebUI-Memory aus 2.17 und die Desktop-Control-/WinApp-Basis aus 2.18; außerdem Component Isolation, interne Komponentenversions-Registry, automatische Release Attestation, sicheren OpenWebUI-Credential-Bootstrap, Codex Local `0.2.1`, RAG `0.4.0`, unterstützten Open-Terminal-Fallback, deterministische Builds, PackageSelfTest und die bis zu diesem Release validierten Installer-/Reconciliation-Härtungen. |
