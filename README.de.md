...
Open Terminal `0.1.1` bleibt vollständig installiert, unterstützt, über den zentralen Lifecycle verwaltet und ausführbar, ist seit KI-Stack 2.15 jedoch nicht mehr der Standardpfad für Terminal-/Host-Control der produktiven MCP-fähigen Profile. Der MCP Runtime ist der primäre Pfad.
