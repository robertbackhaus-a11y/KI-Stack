# KI-Stack OpenWebUI Visual Pack 2.0.5-rc2
...
```powershell
.\Install-KIStack-OpenWebUI-VisualPack-v2.0.5-rc2.ps1 -Action Preflight
.\Install-KIStack-OpenWebUI-VisualPack-v2.0.5-rc2.ps1 -Action Install
.\Install-KIStack-OpenWebUI-VisualPack-v2.0.5-rc2.ps1 -Action Validate
```
