...
function Install-KIModuleCutover {
    ...
    $marker=[pscustomobject][ordered]@{managedBy='KI-STACK-CUTOVER-MANAGED';schemaVersion='1.0';release='KI-Stack-Cutover-Execute-v1.6.4';installedAt=(Get-Date).ToString('o');transactionId=[string]$Context.Transaction.transactionId;moduleRoot=$root;readinessReport=$readinessPath}
