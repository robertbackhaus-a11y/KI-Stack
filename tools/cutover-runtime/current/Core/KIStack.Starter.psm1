...
function Test-KIStarterPackage {
    ...
    $requiredPaths = @(
        ...
        'Tests\Test-KIStackComfyUIDirtyRepository.ps1',
        'Tests\Test-KIStackIntegrationRebootResume.ps1',
        'Tests\Test-KIStackIntegrationSearXNGPin.ps1',
        'Tests\Test-KIStackPathResolution.ps1',
        'Tests\Test-KIStackEmbeddedPreflight.ps1',
        'Embedded\Preflight\Source\install-plan.source.json',
        'Embedded\Preflight\Source\preflight-report.json',
        'Embedded\Preflight\Source\versions.lock.json',
