...
function New-ImagePackToolForm {
    ...
    [ordered]@{
        ...
        meta=[ordered]@{description='Direkte FLUX2-Bildgenerierung über die lokale ComfyUI-API.';manifest=[ordered]@{managedBy='KI-STACK-OPENWEBUI-IMAGE-PACK';version='1.9.2';workflow='FLUX2-Klein-9B-OpenWebUI-API-FLAT'};has_user_valves=$false}
        access_grants=@()
    }
}
