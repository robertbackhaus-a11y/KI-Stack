...
function New-ImagePackToolForm {
    ...
    [ordered]@{
        ...
        meta=[ordered]@{description='Direkte FLUX2- und Pony-SDXL-Bildgenerierung über die lokale ComfyUI-API.';manifest=[ordered]@{managedBy='KI-STACK-OPENWEBUI-IMAGE-PACK';version='1.10.0';canonical_id='ki-stack-generate-image';workflows=@('FLUX2-Klein-9B-OpenWebUI-API-FLAT','PONY-SDXL-OpenWebUI-API')};has_user_valves=$false}
        access_grants=@()
    }
}
