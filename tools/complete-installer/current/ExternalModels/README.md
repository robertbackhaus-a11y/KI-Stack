# Optional model cache for Complete Installer 2.4.0-rc11
...
Preloads are never required. Heretic is chat-only, Nomic embedding-only, and the official Qwen artifact is used only by Z-Image.
