...
The Complete Installer delegates to the single importer contained in its Models / Workflows 1.4.3 payload. No model file is embedded in this directory or in the release archive.
