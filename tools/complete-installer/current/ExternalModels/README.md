...
The Complete Installer delegates to the single importer contained in its Models / Workflows 1.4.8 payload. No model file is embedded in this directory or in the release archive. See `docs/en/KI-Stack-Manual-Model-Provisioning.md` and `docs/de/KI-Stack-Manuelle-Modellbereitstellung.md`.
