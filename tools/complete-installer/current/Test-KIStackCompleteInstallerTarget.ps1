...
[pscustomobject]@{version='2.0.0';passed=([bool]$validate.health.passed);auditReadOnly=(-not$audit.mutatesTarget);existingInstallation=$true;health=$validate.health;status='TargetSystemValidatedExistingInstallation'}|ConvertTo-Json -Depth 30
