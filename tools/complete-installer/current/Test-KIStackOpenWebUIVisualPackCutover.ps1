...
try{
    ...
    [pscustomobject]@{passed=$passed;version='2.9.0';checks=[ordered]@{noApiKeyPath=$checkNoApiKey;openWebUIUnreachablePath=$checkOpenWebUIDown;comfyUnreachablePath=$checkComfyDown;successPath=$checkSuccess};targetSystemAccessed=$false}|ConvertTo-Json -Depth 10
