...
if ($manifest.version -ne '2.9.0' -or $manifest.baseVersion -ne '2.8.0') { $fail.Add('Version contract') }
...
try {
    ...
    $null=Update-KICompleteComponentState -Plan $statePlan -TargetRoot $planTarget -CompleteVersion '2.9.0'
    ...
    $null=Update-KICompleteComponentState -Plan $orphanStatePlan -TargetRoot $planTarget -CompleteVersion '2.9.0'
