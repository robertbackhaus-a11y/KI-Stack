...
if ($manifest.version -ne '2.4.0-rc10' -or $manifest.baseVersion -ne '2.3.2') { $fail.Add('Version contract') }
...
try {
    ...
    $null=Update-KICompleteComponentState -Plan $statePlan -TargetRoot $planTarget -CompleteVersion '2.4.0-rc10'
    ...
    $null=Update-KICompleteComponentState -Plan $orphanStatePlan -TargetRoot $planTarget -CompleteVersion '2.4.0-rc10'
