...
The existing-installation operations contract, the inherited Image Pack chat attachment path and all five canonical workflows retain their prior target-system evidence. Image Pack 1.10.0 adds a regression-validated Pony method whose workflow and chat output were practically tested; this is not a complete 1.10.0 target-system validation. Fresh-install behavior remains contract- and fixture-validated rather than physically bare-metal validated.
