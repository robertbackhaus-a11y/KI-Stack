...
- OpenWebUI verwendet Visual Pack 2.0.5-rc3. MP4 wird als genau ein persistenter `type: file`-Downloadanhang über das native `files`-Event ausgegeben.
