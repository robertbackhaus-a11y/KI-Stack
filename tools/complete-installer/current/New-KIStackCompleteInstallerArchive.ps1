...
$stage=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.2.4'
...
$zip=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.2.4.zip';if(Test-Path $zip){Remove-Item $zip -Force}
