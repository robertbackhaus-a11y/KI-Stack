...
$stage=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.2.3'
...
$zip=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.2.3.zip';if(Test-Path $zip){Remove-Item $zip -Force}
