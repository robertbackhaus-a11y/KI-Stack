...
$stage=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.1.1'
...
$zip=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.1.1.zip';if(Test-Path $zip){Remove-Item $zip -Force}
