...
$stage=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.2.5'
...
$zip=Join-Path $OutputDirectory 'KI-Stack-Complete-Installer-v2.2.5.zip';if(Test-Path $zip){Remove-Item $zip -Force}
