# KI-Stack 2.3.2 – Technische Dokumentation

KI-Stack ist ein transaktionsgesicherter lokaler Windows-KI-Stack. Complete Installer 2.3.2 vervollständigt den automatischen Greenfield-Vertrag für das ausschließlich als Embedding verwendete Nomic Q4_K_M; die übrige funktionale Validierung wird unverändert übernommen.
...
Der Nomic-Greenfield-Vertrag, lokale Wiederverwendung, Planung eines fehlenden Artefakts, Cache, Resume, Größe, SHA-256 und atomare Aktivierung verwenden den bestehenden Modellimporter. Eine vollständige reale Greenfield-Neuinstallation auf einem leeren Ziel wurde nicht durchgeführt. Die funktionale Validierung von Heretic, Nomic-Embeddings, Z-Image, WAN2.2, OpenWebUI-Anhängen und Stack-Health wird unverändert übernommen.
