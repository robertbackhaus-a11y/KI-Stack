...
Complete Installer 2.18.2 automatically downloads missing models, including embedding-only Nomic Q4_K_M, from revision-pinned sources in the central model manifest. Manual provisioning is not an installation prerequisite.
