...
| Models / Workflows | 1.4.8, Heretic LM Studio contract | `models-workflows-v1.4.8` | package `SHA256SUMS.txt`; models are external |
...
| Complete Installer | 2.2.8, Heretic LM Studio contract | `complete-v2.2.8` | package `SHA256SUMS.txt` |
