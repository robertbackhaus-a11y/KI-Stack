...
| Models / Workflows | 1.4.7, Heretic LM Studio contract | `models-workflows-v1.4.7` | package `SHA256SUMS.txt`; models are external |
...
| Complete Installer | 2.2.7, Heretic LM Studio contract | `complete-v2.2.7` | package `SHA256SUMS.txt` |
