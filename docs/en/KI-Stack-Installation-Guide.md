# KI-Stack Complete Installer 2.19.0 – Installation and upgrade
...
Download the ZIP and `KI-Stack-Complete-Installer-v2.19.0.zip.sha256` from the same GitHub Release. The authoritative hash is provided only by the sidecar and the GitHub Release description.
